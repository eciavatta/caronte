...
func main() {
	...
	dbUsername := flag.String("dbUsername", "caronte", "name of user in database")
	dbPassword := flag.String("dbPassword", "caronte", "database password")
	...
	logFields := log.Fields{"host": *mongoHost, "port": *mongoPort, "dbName": *dbName, "dbUsername": *dbUsername, "dbPassword": *dbPassword}
