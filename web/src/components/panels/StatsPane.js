...
class StatsPane extends Component {
  ...
  loadResourcesStats = () => {
    backend
      ...
      .catch((res) =>
        this.setState({
          resourcesStats: res.json,
          resourcesStatsStatusCode: res.status,
  ...
  render() {
    ...
    let servicesStats = ports.map((port) => {
      ...
      return (
        <tr key={port} className="row-small row-clickable">
          <td>{port}</td>
    ...
    servicesStats.push(
      <tr key="totals" className="row-small row-clickable font-weight-bold">
        <td>totals</td>
      ...
      <div className="pane-container stats-pane">
        <div className="pane-section stats-list">
          <div className="section-header">
            ...
            <span className="api-response">
              <LinkPopover text={this.state.statsStatusCode} content={this.state.statsResponse} placement="left" />
            </span>
          </div>
        ...
        <div className="pane-section stats-list" style={{paddingTop: '10px'}}>
          <div className="section-header">
            ...
            <span className="api-response">
              <LinkPopover text={this.state.resourcesStatsStatusCode} content={this.state.resourcesStatsResponse} placement="left" />
            </span>
          </div>
